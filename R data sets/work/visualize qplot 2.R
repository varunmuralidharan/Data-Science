...
#-----------------visualizing qplot 2-   with new split--------------------------------------
...
#transparency-----values from 0-1    0-fully transparent  1- fully opaque
qplot(data=merged,x=Internet.users,y=Birth.rate,colour=region,size=I(5),shape=I(19),alpha=I(0.6))

#giving heading/Title to plot

qplot(data=merged,x=Internet.users,y=Birth.rate,colour=region,size=I(5),shape=I(19),alpha=I(0.6),main="Internet.users vs Birth.rate")
